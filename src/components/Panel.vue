<template>
  <router-link :to="station" tag="div" class="panel flex mt-[24px]">
    ...
    <svg class="shape pt-[inherit] opacity-80" viewBox="-10.929 -389.426 226.93 154"
      :style="{ fill: `url(#${color})` }">
      <defs>
    ...
    <div class="flex flex-row m-h-full w-full justify-between">
      ...
      <div class="flex flex-col justify-between z-10">
        <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="20.75" height="19.907" viewBox="0 0 20.75 19.907">
            <path
              ...
              transform="translate(-8.707 -3.75)" fill="#323232" />
            <path
              ...
              transform="translate(-7.875 -6.605)" fill="#323232" />
          </svg>
...
onMounted(() => {
  fetch(`https://lzch1.pythonanywhere.com/daily_prediction/${props.station}/`)
    .then((response) => {
